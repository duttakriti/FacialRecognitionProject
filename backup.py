...
for cl in myList:
    ...
    classNames.append(os.path.splitext(cl)[0]) #print name without filetype
print(classNames)
...
def findEncodings(images):  #to extract encodings of "images"
    ...
    for img in images:   #extract each img in images
        ...
        encodeList.append(encode)  #added to encodeList
    return encodeList
...
encodeListKnown = findEncodings(images)   #encoding of known imgs from database
